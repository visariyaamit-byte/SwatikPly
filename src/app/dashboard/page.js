...
import { getProductTypes, getCompanies, getBoardGrades, getBoardCompanies } from '@/app/actions/reports'
  ...
  return (
    <div>
      ...
      <SalesReports
        ...
        boardCompanies={boardCompaniesResult.data || []}
      />
    </div>
  )
}