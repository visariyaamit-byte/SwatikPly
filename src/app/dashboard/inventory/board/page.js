...
import { BOARD_MEASUREMENTS, BOARD_THICKNESS } from '@/lib/constants'
...
export default async function BoardInventoryPage() {
  ...
  // Group by company
  const boardByCompany = boardInventory.reduce((acc, item) => {
    ...
    <div>
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-brand">Board Inventory</h1>
            <p className="text-neutral-600 mt-1">Manage board stock by company</p>
          </div>
